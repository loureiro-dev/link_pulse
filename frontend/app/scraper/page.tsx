...
export default function ScraperPage() {
  ...
  useEffect(() => {
    getLastRun().then((d) => setLastRun(d.last_run)).catch(() => {});
  }, []);
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            O scraper irá visitar todas as páginas em{' '}
            <a href="/pages-manager" className="text-blue-500 hover:underline">Gerenciar Páginas</a>{' '}
            e coletar links de grupos WhatsApp.
            Para descobrir novas páginas automaticamente, use{' '}
            <a href="/discovery" className="text-emerald-500 hover:underline">Descoberta</a>.
          </p>
          <button
            onClick={handleRun}
            disabled={running}
            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white dark:bg-gray-800 p-3 rounded-lg">
                  <p className="text-xs text-gray-500">Páginas Verificadas</p>
                  <p className="text-2xl font-bold text-gray-900 dark:text-white">{result.total_checked}</p>
                </div>
                <div className="bg-white dark:bg-gray-800 p-3 rounded-lg">
                  <p className="text-xs text-gray-500">Links Encontrados</p>
      ...
      {lastRun && (
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-medium text-gray-900 dark:text-white text-sm">Última Execução</p>
